	...
	<article id="bo_v" style="width:<?php echo $width; ?>">
		...
		<div id="bo_v_top">
			...
			<ul class="bo_v_com">
				...
				<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 counsel_btn"><?php echo $board['bo_subject']?></a></li><?php } ?>
			</ul>
			<?php
		...
		<section id="bo_v_atc">
			...
			상담종류: <?php echo $view['ca_name']; ?> <br />
			<?php if($bo_table=="reservation"){?>
			상담시간: <?php echo $view['wr_3']."/".$view['wr_4']; ?> <br />	
			<?} ?>
			수술부위: <?php echo $view['wr_1']; ?> <br />
			이메일: <?php echo $view['wr_email']; ?> <br />
			연락처: <?php echo $view['wr_2']; ?> <br />

			상담내용: <?php echo get_view_thumbnail($view['content']); ?>
			</div>
